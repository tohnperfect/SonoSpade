...
\noindent\textbf{Code availability.} The implementation, the training and evaluation scripts, and the data preparation pipeline are available at \url{https://github.com/tohnperfect/SonoSpade}.
