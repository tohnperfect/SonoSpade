...
In an in-the-loop proof of concept, on an organ-conditioned task scored by a \emph{fixed} real-trained recognizer, the per-tissue reward gives the highest ground-truth liver visibility in all three seeds. Code is released.\footnote{\url{https://github.com/tohnperfect/SonoSpade}}
...
\noindent\textbf{How good are the pseudo-labels?} $S_{US}$ is trained only in simulation, yet it is what
